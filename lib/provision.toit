...
/**
Service for implementing Espressif's Unified Provisioning.
...
class Provision:
  ...
  /**
  Constructs a BLE provisioning service.
  */
  constructor.ble service_name/string proof_of_possession/string="" protection/int=1:
  ...
  */
  constructor.ap service_name/string service_key/string="" protection/int=1:
